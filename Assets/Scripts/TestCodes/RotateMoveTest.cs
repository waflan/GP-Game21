...
// Mathf.Atan2(nextLocalRot.w,nextLocalRot.x)*Mathf.Rad2Deg
            ...
            angle = Vector3.Angle(Vector3.up,axis)-90;
            ...
            if(Input.GetKey(KeyCode.LeftShift)){
                rx+=(Mathf.Rad2Deg*Mathf.Atan2(playerUpVector.x,playerUpVector.z)-Mathf.Rad2Deg*Mathf.Atan2(beforeUpVector.x,beforeUpVector.z))*(angle/90);
